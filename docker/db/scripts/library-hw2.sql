...
CREATE TABLE library.Book (
	...
	"ISBN" varchar(13) NOT NULL DEFAULT '1' PRIMARY KEY
);
...
ALTER TABLE library.Publisher ADD FOREIGN KEY ("publisherId") REFERENCES library.Book("bookId");

ALTER TABLE library.BookCopy ADD FOREIGN KEY ("bookCopyId") REFERENCES library.Book("bookId");
